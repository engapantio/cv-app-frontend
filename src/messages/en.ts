export const en = {
  ...
  common: {
    ...
    languageAlreadyExists: "This language already exists",
    updateLanguageFailed: "Failed to update language",
    deleteLanguageFailed: "Failed to delete language",
    ...
    languagesDeletedFailed: "Failed to delete languages",
    ...
    removeSkillsFailed: "Failed to remove skills",
    skillUpdatedSuccess: "Skill updated successfully",
    createCvFailed: "Failed to create CV",
