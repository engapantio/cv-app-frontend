...
const OpenDepartmentOverlay = dynamic(
  () => import("./open-department-overlay").then((m) => m.OpenDepartmentOverlay),
  { loading: () => null },
);
const CreateDepartmentDialog = dynamic(
  () => import("./create-department-dialog").then((m) => m.CreateDepartmentDialog),
  { loading: () => null },
);
const UpdateDepartmentDialog = dynamic(
  () => import("./update-department-dialog").then((m) => m.UpdateDepartmentDialog),
  { loading: () => null },
);
const DeleteDepartmentDialog = dynamic(
  () => import("./delete-department-dialog").then((m) => m.DeleteDepartmentDialog),
  { loading: () => null },
);
...
interface DepartmentsTableProps {
  ...
  setDeleteTarget: (target: DepartmentItem | null) => void;
  updateTarget: DepartmentItem | null;
  setUpdateTarget: (target: DepartmentItem | null) => void;
  openTarget: DepartmentItem | null;
  setOpenTarget: (target: DepartmentItem | null) => void;
  ...
  handleDeleted: (departmentId: string) => void;
  globalFilter: string;
...
export function DepartmentsTable({
  ...
  return (
    <>
                ...
                {loading ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={columnCount}>
                      <TableEmptyState message={tCommon("noDepartmentsFound")} responsive />
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
      ...
      {openTarget && (
        <OpenDepartmentOverlay target={openTarget} onClose={() => setOpenTarget(null)} />
      )}
