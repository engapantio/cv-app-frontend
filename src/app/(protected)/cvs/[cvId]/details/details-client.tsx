...
function CvDetailsForm({
  ...
  return (
    <div>
      <div className="flex items-center h-11 gap-2 text-sm text-muted-foreground mb-6">
        <Link href="/cvs" className="hover:text-primary transition-colors">
          CVs
        </Link>
        <ChevronRight className="size-5" />
        <span className="text-primary">{cv.name}</span>
      </div>

      <Tabs defaultValue="details" className="w-full">
        <TabsList variant="line" className="mb-6 gap-0">
          <TabsTrigger value="details" className="uppercase w-[150px] text-center text-foreground data-active:text-primary data-active:after:opacity-100">
            Details
          </TabsTrigger>
          <TabsTrigger value="skills" disabled className="uppercase w-[150px] text-center text-foreground">
            Skills
          </TabsTrigger>
          <TabsTrigger value="projects" disabled className="uppercase w-[150px] text-center text-foreground">
            Projects
          </TabsTrigger>
          <TabsTrigger value="preview" disabled className="uppercase w-[150px] text-center text-foreground">
            Preview
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="skills">
          <p className="text-muted-foreground text-center py-10">Skills management coming soon.</p>
        </TabsContent>
        <TabsContent value="projects">
          <p className="text-muted-foreground text-center py-10">Projects management coming soon.</p>
        </TabsContent>
        <TabsContent value="preview">
          <p className="text-muted-foreground text-center py-10">Preview coming soon.</p>
        </TabsContent>
      </Tabs>
    </div>
  );
