...
export type LoginQuery = { login: { access_token: string, refresh_token: string, user: { id: string, created_at: string, email: string, is_verified: boolean, department_name: string | null, position_name: string | null, role: UserRole, profile: { id: string, first_name: string | null, last_name: string | null, full_name: string | null, avatar: string | null, skills: Array<{ name: string, mastery: Mastery }>, languages: Array<{ name: string, proficiency: Proficiency }> }, cvs: Array<{ id: string, name: string, education: string | null, description: string }> | null, department: { id: string } | null, position: { id: string } | null } } };
...
export type SignupMutation = { signup: { access_token: string, refresh_token: string, user: { id: string, created_at: string, email: string, is_verified: boolean, department_name: string | null, position_name: string | null, role: UserRole, profile: { id: string, first_name: string | null, last_name: string | null, full_name: string | null, avatar: string | null }, cvs: Array<{ id: string }> | null, department: { id: string } | null, position: { id: string } | null } } };
...
export type AddCvProjectMutation = { addCvProject: { id: string, created_at: string, name: string, description: string } };
...
export type AddCvSkillMutation = { addCvSkill: { id: string, created_at: string, name: string, description: string } };
...
export type DeleteCvSkillMutation = { deleteCvSkill: { id: string, created_at: string, name: string, description: string } };
...
export type CvQuery = { cv: { id: string, created_at: string, name: string, education: string | null, description: string, user: { id: string, email: string, profile: { id: string, full_name: string | null, avatar: string | null } } | null, projects: Array<{ __typename: 'CvProject' }> | null, skills: Array<{ __typename: 'SkillMastery' }>, languages: Array<{ __typename: 'LanguageProficiency' }> } };

export type CvsQueryVariables = Exact<{ [key: string]: never; }>;


export type CvsQuery = { cvs: Array<{ id: string, created_at: string, name: string, education: string | null, description: string, user: { id: string, email: string } | null, projects: Array<{ __typename: 'CvProject' }> | null, skills: Array<{ __typename: 'SkillMastery' }>, languages: Array<{ __typename: 'LanguageProficiency' }> }> };
...
export type RemoveCvProjectMutation = { removeCvProject: { id: string, created_at: string, name: string, description: string } };
...
export type UpdateCvProjectMutation = { updateCvProject: { id: string, created_at: string, name: string, description: string } };
...
export type UpdateCvSkillMutation = { updateCvSkill: { id: string, created_at: string, name: string, description: string } };
...
export type UpdateCvMutation = { updateCv: { id: string, created_at: string, name: string, education: string | null, description: string } };
...
export type CreateDepartmentMutation = { createDepartment: { id: string, created_at: string, name: string } };
...
export type DepartmentsQuery = { departments: Array<{ id: string, created_at: string, name: string }> };
...
export type UpdateDepartmentMutation = { updateDepartment: { id: string, created_at: string, name: string } };
...
export type CreateLanguageMutation = { createLanguage: { id: string, created_at: string, iso2: string, name: string, native_name: string | null } };
...
export type LanguagesQuery = { languages: Array<{ id: string, created_at: string, iso2: string, name: string, native_name: string | null } | null> };
...
export type UpdateLanguageMutation = { updateLanguage: { id: string, created_at: string, iso2: string, name: string, native_name: string | null } };
...
export type CreatePositionMutation = { createPosition: { id: string, created_at: string, name: string } };
...
export type PositionsQuery = { positions: Array<{ id: string, created_at: string, name: string }> };
...
export type UpdatePositionMutation = { updatePosition: { id: string, created_at: string, name: string } };
...
export type AddProfileLanguageMutation = { addProfileLanguage: { id: string, created_at: string, languages: Array<{ name: string, proficiency: Proficiency }> } };
...
export type AddProfileSkillMutation = { addProfileSkill: { id: string, created_at: string, skills: Array<{ name: string, mastery: Mastery, categoryId: string | null }> } };
...
export type DeleteProfileLanguageMutation = { deleteProfileLanguage: { id: string, created_at: string, languages: Array<{ name: string, proficiency: Proficiency }> } };
...
export type DeleteProfileSkillMutation = { deleteProfileSkill: { id: string, created_at: string, skills: Array<{ name: string, mastery: Mastery, categoryId: string | null }> } };
...
export type ProfileQuery = { profile: { id: string, created_at: string, first_name: string | null, last_name: string | null, full_name: string | null, avatar: string | null, skills: Array<{ name: string, mastery: Mastery, categoryId: string | null }>, languages: Array<{ name: string, proficiency: Proficiency }> } };
...
export type UpdateProfileLanguageMutation = { updateProfileLanguage: { id: string, created_at: string, languages: Array<{ name: string, proficiency: Proficiency }> } };
...
export type UpdateProfileSkillMutation = { updateProfileSkill: { id: string, created_at: string, skills: Array<{ name: string, mastery: Mastery, categoryId: string | null }> } };
...
export type UpdateProfileMutation = { updateProfile: { id: string, created_at: string, first_name: string | null, last_name: string | null, full_name: string | null, avatar: string | null } };
...
export type CreateProjectMutation = { createProject: { id: string, created_at: string, name: string, internal_name: string, domain: string, start_date: string, end_date: string | null, description: string, environment: Array<string> } };
...
export type UpdateProjectMutation = { updateProject: { id: string, created_at: string, name: string, internal_name: string, domain: string, start_date: string, end_date: string | null, description: string, environment: Array<string> } };
...
export type CreateSkillMutation = { createSkill: { id: string, created_at: string, name: string, category_name: string | null, category_parent_name: string | null } };
...
export type SkillCategoriesQuery = { skillCategories: Array<{ id: string, name: string, order: number, parent: { id: string, name: string, order: number } | null, children: Array<{ id: string, name: string, order: number }> }> };

export type SkillsQueryVariables = Exact<{ [key: string]: never; }>;


export type SkillsQuery = { skills: Array<{ id: string, created_at: string, name: string, category_name: string | null, category_parent_name: string | null, category: { id: string, name: string, order: number, parent: { id: string, name: string, order: number } | null, children: Array<{ id: string, name: string, order: number }> } | null }> };
...
export type UpdateSkillMutation = { updateSkill: { id: string, created_at: string, name: string, category_name: string | null, category_parent_name: string | null } };
...
export type CreateUserMutation = { createUser: { id: string, created_at: string, email: string, is_verified: boolean, role: UserRole } };
...
export type UserQuery = { user: { id: string, created_at: string, email: string, is_verified: boolean, role: UserRole, department_name: string | null, position_name: string | null, profile: { id: string, created_at: string, first_name: string | null, last_name: string | null, full_name: string | null, avatar: string | null, skills: Array<{ name: string, mastery: Mastery, categoryId: string | null }>, languages: Array<{ name: string, proficiency: Proficiency }> }, department: { id: string, created_at: string, name: string } | null, position: { id: string, created_at: string, name: string } | null, cvs: Array<{ id: string, created_at: string, name: string, education: string | null, description: string, user: { id: string, email: string, profile: { id: string, full_name: string | null, avatar: string | null } } | null }> | null } };

export type UsersQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersQuery = { users: Array<{ id: string, created_at: string, email: string, is_verified: boolean, role: UserRole, department_name: string | null, position_name: string | null, profile: { id: string, created_at: string, first_name: string | null, last_name: string | null, full_name: string | null, avatar: string | null }, department: { id: string, created_at: string, name: string } | null, position: { id: string, created_at: string, name: string } | null, cvs: Array<{ id: string, created_at: string, name: string, description: string }> | null }> };
...
export type UpdateUserMutation = { updateUser: { id: string, created_at: string, email: string, is_verified: boolean, role: UserRole } };
...
export const VerifyMailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"VerifyMail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"mail"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"VerifyMailInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"verifyMail"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"mail"},"value":{"kind":"Variable","name":{"kind":"Name","value":"mail"}}}]}]}}]} as unknown as DocumentNode<VerifyMailMutation, VerifyMailMutationVariables>;
