...
export type CvQuery = { cv: { id: string, created_at: string, name: string, education: string | null, description: string, user: { id: string, email: string } | null, projects: Array<{ __typename: 'CvProject' }> | null, skills: Array<{ name: string, mastery: Mastery, categoryId: string | null }>, languages: Array<{ __typename: 'LanguageProficiency' }> } };
...
export type SkillsQuery = { skills: Array<{ id: string, created_at: string, name: string, category_name: string | null, category_parent_name: string | null, category: { id: string, name: string, order: number, parent: { id: string, name: string, order: number } | null } | null }> };
